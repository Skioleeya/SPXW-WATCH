 ...
 * 性能取舍
 * --------
 * 满场是整个交易日网格：30 秒粒度下最多 2360 列（切掉 09:25–09:30 空档后），
 * 乘上约 40 档行权价 ≈ 9.4 万个网格。ECharts 的 heatmap 在 canvas 上渲染
 ...
 * 觉得密就把周期调粗（5 分钟全时段只有 237 列）——密度交给周期选择器，
 * 不要靠砍历史段来"变清楚"（那会让交易日早段静默消失）。
 * ------------------------------------------------------------------ */
